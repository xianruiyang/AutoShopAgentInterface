...
- `scripts/autoshop-agent.exe`: Packaged CLI binary, currently `v0.8.131`.
- `references/`: Detailed command, format, UI refresh, testing, EtherCAT slave template references, motion-axis `outputDevice` JSON binding, CANLink `programConfig` editing, and read-only CANopen EDS catalog export.
