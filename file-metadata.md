...
- `scripts/autoshop-agent.exe`: Packaged CLI binary, currently `v0.8.129`.
- `references/`: Detailed command, format, UI refresh, testing, and EtherCAT slave template references, including motion-axis `outputDevice` JSON binding.
