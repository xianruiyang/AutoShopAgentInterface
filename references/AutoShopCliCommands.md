...
适用版本：autoshop-agent.exe v0.8.39。
...
单位换算设置中的 reverseDirection 表示“反向”复选框；workspace apply 会同步 AutoShop 手动保存确认的 0x80000118 可见复选框位和 0x80000117 联动标志。pulsesPerRevolution 使用十进制数表示，AutoShop 中的 16#1000000 对应 JSON 值 16777216。
